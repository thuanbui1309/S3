...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        subject_id = int(os.path.basename(os.path.dirname(self.seqs_labels_path_pair[idx][0])).split('_')[0][4:]) - 1
...
class LoadDataset(object):
    def __init__(self, args):
        self.args = args
        self.datasets_dir = os.path.join(args.base_dir, 'datasets', args.datasets)
